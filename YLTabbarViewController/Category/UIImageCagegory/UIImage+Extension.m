...
+ (UIImage *)resizableImageWithName:(NSString *)name {
    ...
    return [image resizableImageWithCapInsets:UIEdgeInsetsMake(image.size.width/2 - 2, image.size.width/2, image.size.width/2, image.size.width/2) resizingMode:(UIImageResizingModeTile)];
}
